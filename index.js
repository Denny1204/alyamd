...
const phoneNumber = await question('Masukin nomor yang mau dijadikan bot.. contoh: 6283898771094\n');
...
//hydro.groupAcceptInvite("DpuIfQNn4WZGG4O0YtDn7S")
//hydro.groupAcceptInvite("BiF6tm2GSLAAeipD6rkwte")
		}
} catch (err) {
...
antidelete.registerListener(hydro)
